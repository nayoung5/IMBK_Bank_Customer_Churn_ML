...
2) LabelEncoder 적용 : country, gender 모두 순서 의미가 없는 범주형이나, 트리 기반 모델(RF, GBM, XGB)은 정수 인코딩만으로도 분기점을 스스로 학습하므로 OneHotEncoding 없이 LabelEncoder 만으로 충분하며 범주 수가 적어 차원 증가 부담도 없음
...
### 8. 인사이트 제안
<img width="757" height="534" alt="image" src="https://github.com/user-attachments/assets/28d6e3b3-fe4a-4362-a2ce-9498bd566b54" />
